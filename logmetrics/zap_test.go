...
func Example_zapJSON() {
	...
	// output:
	// {"level":"debug","name":"example","caller":"logmetrics/zap_test.go:42","msg":"test debug message","version":"go1.22.4"}
	// {"level":"info","name":"example","caller":"logmetrics/zap_test.go:43","msg":"test info message","version":"go1.22.4"}
}

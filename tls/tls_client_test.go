...
func TestClientTLSGoogle(t *testing.T) {
	...
	t.Logf("TLS1.%d", state.Version-tls.VersionTLS10)
...
// 이후
// go run /usr/local/go/src/crypto/tls/generate_cert.go -host localhost -ecdsa-curve P256
// 로 개인키와, 개인키로 만든 인증서를 생성한다.
